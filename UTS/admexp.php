...
<html lang="en">
    <head>
        ...
        <title>Admin Experience - Portofolio Pedro</title>
...
<header class="masthead">
                <div class="text-center">
                    <h2 class="masthead-subheading text-uppercase">Admin Experience</h2>
                    <h3 class="section-subheading text-muted">Your experience page data list</h3>
                </div>
        </header>
        ...
        <div class="container">
        <a href="tambahexp.php" class="btn btn-info">ADD</a>
            <div class="row">
                <div class="col-md-12">
            ...
            ?>
                    ...
                    <td>
                        <a href="editexp.php?id=<?php echo $row["id"] ?>" class="btn btn-info">EDIT</a>
                        <a href="deleteexp.php?id=<?php echo $row["id"]?>" class="btn btn-danger">DELETE</a>
                    </td>
                    </tr>
            <?php 
            }
