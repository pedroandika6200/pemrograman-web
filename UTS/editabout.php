...
<html lang="en">
    <head>
        ...
        <title>Edit About - Portofolio Pedro</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="admabout.php">Back</a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<header class="masthead">
                <div class="text-center">
                    <h2 class="masthead-subheading text-uppercase">Edit About</h2>
                    <h3 class="section-subheading text-muted">Edit your about data list</h3>
                <div>
        </header>
    ...
    while($d = mysqli_fetch_array($data)){
        ?>
        <div class="container">
        <form id="myform" method="post" action="prosesabout.php">
                ...
                <div class="form-group"> 
                 ...
                 <div class="form-group"> 
                    <label>Description</label>   
                     <input type="text" class="form-control" name="ket" value="<?php echo $d['ket']; ?>">
                 </div>
                <div class="form-group"> 
                    <label>Content</label>   
