...
<html lang="en">
    <head>
        ...
        <title>Edit Experience - Portofolio Pedro</title>
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="admexp.php">Back</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead">
                <div class="text-center">
                    <h2 class="masthead-subheading text-uppercase">Edit Experience</h2>
                    <h3 class="section-subheading text-muted">Edit your experience data list</h3>
                </div>
        </header>
    <section class="page-section">
    <?php
    $id = $_GET['id'];
    $data = mysqli_query($conn,"SELECT * FROM exp WHERE id='$id'");
    while($d = mysqli_fetch_array($data)){
        ?>
        <div class="container">
        <form id="myform" method="post" action="prosesexp.php">
