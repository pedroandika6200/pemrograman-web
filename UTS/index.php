...
<html lang="en">
    <head>
        ...
        <title>Index - Portofolio Pedro</title>
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="text-center">
                <h2 class="masthead-subheading">Welcome To My Website!</h2>
                <h3 class="section-subheading text-muted">It's Nice To Meet You<br></h3>
            </div>
        </header>
        <!-- Team-->
        <section class="page-section" id="team">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">My name is Pedro</h3>
                </div>
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">I made this website as an assignment for my midterm test in Web Programming and Project Class. This website contain all about myself, Pedro and that's why this website's name is Portofolio Pedro.</p></div>
                </div>
            </div>
        </section>
        <!-- Footer-->
