...
<html lang="en">
    <head>
        ...
        <title>Admin Education - Portofolio Pedro</title>
    ...
    <body id="page-top">
        ...
        <header class="masthead">
                <div class="text-center">
                    <h2 class="masthead-subheading text-uppercase">Admin Education</h2>
                    <h3 class="section-subheading text-muted">Your education page data list</h3>
                </div>
        </header>
        ...
        <div class="container">
        <a href="tambahedu.php" class="btn btn-info">ADD</a>
            <div class="row">
                <div class="col-md-12">
            ...
            ?>
                    ...
                    <td>
                        <a href="editedu.php?id=<?php echo $row["id"] ?>" class="btn btn-info">EDIT</a>
                        <a href="deleteedu.php?id=<?php echo $row["id"]?>" class="btn btn-danger">DELETE</a>
                    </td>
                    </tr>
            <?php 
            }
