...
<html lang="en">
    <head>
        ...
        <title>Add About - Portofolio Pedro</title>
    ...
    <body id="page-top">
        ...
        <header class="masthead">
                <div class="text-center">
                    <h2 class="masthead-subheading text-uppercase">Add About</h2>
                    <h3 class="section-subheading text-muted">Add your about data list</h3>
                </div>
        </header>
<body>
<section class="page-section">
    <div class="container">
        <h2>Input About</h2>
        <form method="post" action="konfirabout.php">
