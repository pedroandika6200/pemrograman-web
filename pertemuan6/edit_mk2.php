...
<body>
    ...
    if (isset($_POST['kodemk'])) {
        ...
        $sks = $_POST['sks']; 
         ...
         //buat koneksi
         $strSQL = "INSERT INTO maatakuliah (kodemk, namamk, kategori, sks) 
         VALUES ('$kodemk','$namamk','$kategori','$sks')";
         
         $runStrSQL = mysqli_query($conn,$runStrSQL);        
         if ($runSQL) {
             $status = 1; //sukses
         }  
         else {
        ...
        $_kodemk = $_GET['kodemk'];
        $strSQL = "SELECT * FROM maatakuliah WHERE kodemk='".$_kodemk."'";
    ...
    <!-- ini end modal -->
        ...
        <form id="myform" method="post" action="registrasi_mk2.php">
            <div class="form-group">
                ...
                <input id="kodemk" class="form-control" type="text" name="kodemk" value="<?php echo $_kodemk ?>" readonly>
            </div>
            <div class="form-group">
