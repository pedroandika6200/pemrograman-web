...
<head>
    ...
    <linl rel="stylesheet" href="https://cdn.datatables.net/1.10.22/css/dataTables.bootstrap4.min.css">
</head>
<body>
<?php  
...
<div class="container">
    ...
    <div class="row mt-3 mb-3">
        <div class="col-md-12">
        <a href="registrasi_mk2.php" class="btn btn-primary">
        Input Data
        </a>
        </div>
    </div>
...
<?php
//buat SQL
$strSQL = "SELECT * FROM maatakuliah";
